    ...
    <div>
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="flipper">
            <div className="front">
            <h1 className="topText">Earn</h1>     
            </div>
            <div className="back">
            <h2 className="cardBack">We want to make your child's learning experience fun, so we've made a reward system to encourage them to keep on playing and learning. When they complete a game, they earn "Stars" which can be used to track your child's progress and give you an idea of how they're doing. However, Stars can only be tracked if your child has a Star Jump account. </h2>
            </div>
          </div>
        </div>
          </div>
